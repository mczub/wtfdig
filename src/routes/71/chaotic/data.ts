import type { Alliance, Alignment, FightConfig, Role } from '$lib/types';

export type StartingArea = 'Tiles' | 'Platform';

export interface ChaoticMechanicStrat {
  mechanic: string;
  description: string;
  imageUrl?: string;
  imageRotated?: string;
...
export const chaoticFightConfig: FightConfig = {
  fightKey: 'chaotic',
  title: 'The Cloud of Darkness (Chaotic)',
  abbreviatedTitle: 'Chaotic',
  subtitle: 'Patch 7.1',
  ...
  strats: {
    ...
    idyll: { label: 'Idyll/game8', jpRoles: true }
  },
  allianceOptions: ['A', 'B', 'C'],
  alignmentOptions: [
    { value: 'original', label: 'Original' },
    { value: 'truenorth', label: 'True North' },
    { value: 'relative', label: 'Wall Relative' }
  ]
};

const raidplanStrat: ChaoticStrat = {
  stratName: 'raidplan',
...
const codcarStrat: ChaoticStrat = {
  stratName: 'codcar',
  stratUrl:
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentImages: {
            original: '',
            truenorth: '',
            relative: './strats/codcar/platform-west-aoe-spread-rotated.png'
          },
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 41% 67%, black 12%, rgba(0, 0, 0, 0.4) 12%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentImages: {
            original: '',
            truenorth: '',
            relative: './strats/codcar/platform-east-aoe-spread-rotated.png'
          },
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 60% 65%, black 12%, rgba(0, 0, 0, 0.4) 12%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 37% 14%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 40% 19%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 59% 73%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 40% 68%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 62% 21%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 64% 13%, black 10%, rgba(0, 0, 0, 0.4) 10%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 86% 30%, black 8%, rgba(0, 0, 0, 0.4) 8%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 16% 32%, black 8%, rgba(0, 0, 0, 0.4) 8%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 85% 27%, black 8%, rgba(0, 0, 0, 0.4) 8%)'
          }
        },
        {
          mechanic: 'swap',
      ...
      strats: [
        ...
        },
        {
          ...
          alignmentMasks: {
            original: '',
            truenorth: '',
            relative: 'radial-gradient(circle at 13% 27%, black 8%, rgba(0, 0, 0, 0.4) 8%)'
          }
        },
        {
          mechanic: 'swap',
...
const healerOutStrat: ChaoticStrat = {
  stratName: 'healerout',
