...
<script lang="ts">
  ...
  function getOptionsString(
    ...
    if (stratName === 'idyll' && roleAbbrev !== jpRoleAbbrev[roleAbbrev]) {
      return `${stratNames[stratName]} - Alliance ${alliance} ${roleAbbrev}/${jpRoleAbbrev[roleAbbrev]}`;
    }
...
<div class="container grow px-4 mx-auto mb-6">
  <div class="container">
    <div class="mb-6">
      <div class="preset-typo-display-1 mt-2 lg:mt-0 lg:-mb-2">The Cloud of Darkness (Chaotic)</div>
      ...
      <div class="space-y-5 v-full dark">
        ...
        <div>
          ...
          <Segment
            ...
            name="stratName"
            value={stratName}
            onValueChange={(e) => (stratName = e.value)}
          >
