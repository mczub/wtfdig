...
function getStringObject(
  ...
  for (const [key, strat] of Object.entries(stratRecord)) {
    const mechStrat = strat[mechanic] as any;
    if (role) {
      stringObject[key] = (mechStrat[role]?.[property] as string) || '';
    } else {
      stringObject[key] = (mechStrat[property] as string) || '';
    }
  }
  return stringObject;
}
...
const toxicAdds: Record<string, Record<string, PlayerMechStrat>> = {
  ...
  wave3: {
    ...
    H1: {
      ...
      party: 1,
      description:
        'If targeted by Jabber, go Southeast and single target\nKill Jabber, then Squirrels, then Cat',
      imageUrl: './m6s/adds/toxic-wave3.webp'
    },
    H2: {
      role: 'Healer',
...
const latteAdds: Record<string, Record<string, PlayerMechStrat>> = {
  wave1: {
    MT: {
      ...
      party: 1,
      description:
        '1. Pull boss and 2 squirrels east\n2. Mitigate and AoE\n3. If cat jumps near, dodge AoE.',
  ...
  wave2: {
    ...
    H1: {
      ...
      party: 1,
      description:
        '1. Once ray targets a ranged, join MT and AoE all of them.\n2. Once this ray is dead, focus the other ray.',
      imageUrl: ''
    },
    H2: {
      role: 'Healer',
...
const yukizuriAdds: Record<string, Record<string, PlayerMechStrat>> = {
  ...
  wave4: {
    ...
    OT: {
      ...
      party: 2,
      description:
        'Pick up new Yan, take them to 4 marker\nOnce Jabber dies, take Yans deep into SW corner\nAfter Squirrels die, take Yans to boss and kill\nCURRENT OBJECTIVE: SURVIVE'
    },
    H1: {
      role: 'Healer',
      party: 1,
...
const cleaveAdds: Record<string, Record<string, PlayerMechStrat>> = {
  ...
  wave2: {
    MT: {
      ...
      party: 1,
      description:
        'Pick up Squirrels South, bring them to NE Manta as soon as possible\nBring Squirrels to NW Manta when NE Manta dies',
...
const mrAdds: Record<string, Record<string, PlayerMechStrat>> = {
  ...
  wave2: {
    ...
    OT: {
      ...
      party: 2,
      description:
        'Drag Yan away from NE if still alive\nKill NE Manta while cleaving Squirrels\nKill NW Manta, then move North for Wave 3',
      imageUrl: './m6s/adds/mr-wave2.webp'
    },
    H1: {
      role: 'Healer',
          ...
          strats: [
            {
              ...
              description: 'Left',
              imageUrl: './m6s/toxic/double-lps.webp',
              mask: getCircleMaskUrl(31.4, 13.14, 8.8)
            },
            {
              role: 'Tank',
              party: 2,
      ...
      mechs: [
        {
          ...
          strats: [
            ...
            },
            {
              ...
              description: 'East far from boss',
              imageUrl: './m6s/toxic/desert-bombs.webp',
              mask: getCircleMaskUrl(79.97, 57.9, 6)
            },
            {
              role: 'Melee',
              party: 1,
              description: 'West close to boss',
              imageUrl: './m6s/toxic/desert-bombs.webp',
              mask: getCircleMaskUrl(40.69, 36.6, 6)
            },
            {
              role: 'Melee',
              party: 2,
            ...
            },
            {
              ...
              description: 'West far from boss',
              imageUrl: './m6s/toxic/desert-bombs.webp',
              mask: getCircleMaskUrl(19.9, 37.12, 6)
            },
            {
              role: 'Ranged',
              party: 2,
          ...
          strats: [
            {
              ...
              mask: getMultiCircleMaskUrl([16.39, 51.39, 7.0], [69.71, 42.47, 7.0])
            },
            {
              role: 'Tank',
              party: 2,
              description: 'Northwest',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([10.72, 21.81, 7.0], [59.63, 19.26, 7.0])
            },
            {
              role: 'Healer',
              party: 1,
              ...
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([42.66, 29.21, 7.0], [86.29, 15.31, 7.0])
            },
            {
              role: 'Healer',
              party: 2,
              description: 'South',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([13.91, 83.91, 7.0], [70.03, 75.24, 7.0])
            },
            {
              role: 'Melee',
              party: 1,
              description: 'Northwest',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([17.35, 34.05, 7.0], [59.82, 42.09, 7.0])
            },
            {
              role: 'Melee',
              party: 2,
              description: 'Northwest',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([26.47, 32.78, 7.0], [69.52, 19.01, 7.0])
            },
            {
              role: 'Ranged',
              party: 1,
              description: 'Northeast',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([42.44, 53.31, 7.0], [85.71, 45.53, 7.0])
            },
            {
              role: 'Ranged',
              party: 2,
              description: 'South',
              imageUrl: './m6s/toxic/river-lightning.webp',
              mask: getMultiCircleMaskUrl([28.12, 84.17, 7.0], [83.93, 76.77, 7.0])
            }
          ]
        },
        {
          ...
          strats: [
            {
              ...
              mask: getMultiCircleMaskUrl([28.32, 54.57, 10.0], [74.4, 46.3, 10.0])
            },
            {
              role: 'Tank',
              party: 2,
              ...
              imageUrl: './m6s/toxic/river-fire.webp',
              mask: getMultiCircleMaskUrl([11.54, 59.8, 10.0], [57.9, 68.37, 10.0])
            },
            {
              role: 'Healer',
              party: 1,
          ...
          strats: [
            {
              ...
              mask: getCircleMaskUrl(33.2, 85.1, 8.0)
            },
            {
              role: 'Tank',
              party: 2,
              ...
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(62.9, 86.0, 8.0)
            },
            {
              role: 'Healer',
              party: 1,
              ...
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(34.8, 39.6, 8.0)
            },
            {
              role: 'Healer',
              party: 2,
              description: 'East platform\nTake the tower closer to the middle',
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(69.9, 38.7, 8.0)
            },
            {
              role: 'Melee',
              party: 1,
              ...
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(35.0, 69.4, 8.0)
            },
            {
              role: 'Melee',
              party: 2,
              ...
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(62.3, 70.9, 8.0)
            },
            {
              role: 'Ranged',
              party: 1,
              ...
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(16.1, 52.9, 8.0)
            },
            {
              role: 'Ranged',
              party: 2,
              description: 'East platform\nTake the tower further from the middle',
              imageUrl: './m6s/toxic/pudding-towers.webp',
              mask: getCircleMaskUrl(85.9, 33.9, 8.0)
            }
          ]
        }
      ]
          ...
          strats: [
            {
              ...
              mask: getCircleMaskUrl(85.8, 15.2, 8.0)
            },
            {
              role: 'Tank',
              party: 2,
              description: 'Take Right tower furthest from river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(87.6, 59.6, 8.0)
            },
            {
              role: 'Healer',
              party: 1,
              description: 'Left platform\nTake the tower closest to river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(59.6, 72.3, 8.0)
            },
            {
              role: 'Healer',
              party: 2,
              description: 'Right platform\nTake the tower closest to river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(28.2, 43.8, 8.0)
            },
            {
              role: 'Melee',
              party: 1,
              description: 'Take Left tower closest to river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(71.6, 26.6, 8.0)
            },
            {
              role: 'Melee',
              party: 2,
              description: 'Take Right tower closest to river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(72.4, 44.6, 8.0)
            },
            {
              role: 'Ranged',
              party: 1,
              description: 'Left platform\nTake the tower furthest from river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(29.5, 86.1, 8.0)
            },
            {
              role: 'Ranged',
              party: 2,
              description: 'Right platform\nTake the tower furthest from river',
              imageUrl: './m6s/toxic/pudding-422.webp',
              mask: getCircleMaskUrl(16.6, 22.9, 8.0)
            }
          ]
        },
        {
          ...
          strats: [
            {
              ...
              mask: getCircleMaskUrl(12.6, 83.7, 8.0)
            },
            {
              role: 'Tank',
              party: 2,
              description: 'Center South',
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(46.3, 84.8, 8.0)
            },
            {
              role: 'Healer',
              party: 1,
              ...
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(63.3, 86.2, 8.0)
            },
            {
              role: 'Healer',
              party: 2,
              description: 'Center North',
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(46.7, 68.6, 8.0)
            },
            {
              role: 'Melee',
              party: 1,
            ...
            },
            {
              ...
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(28.0, 70.0, 8.0)
            },
            {
              role: 'Ranged',
              party: 1,
              ...
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(79.3, 83.9, 8.0)
            },
            {
              role: 'Ranged',
              party: 2,
              ...
              imageUrl: './m6s/toxic/pudding-800.webp',
              mask: getCircleMaskUrl(66.1, 69.9, 8.0)
            }
          ]
        }
      ]
...
export const m6sStrats: Strat[] = [toxicStrat, game8Strat, mrStrat, latteStrat, yukizuriStrat];

export const m6sFightConfig: FightConfig = {
  fightKey: 'm6s',
  title: 'AAC Cruiserweight M2 (Savage)',
      ...
      options: [
        {
          ...
          url: { name: 'Cleavemaxxing Adds', url: 'https://raidplan.io/plan/ywV9cu6GRQ68SQLy' }
        },
        {
          value: 'game8',
          label: 'Game8',
          badges: [{ text: 'JP', class: 'jp-badge' }],
          url: { name: 'Game8 Adds', url: 'https://game8.jp/ff14/681086' }
        },
        {
          value: 'mr',
          label: 'MR',
          badges: [{ text: 'OCE', class: 'oce-badge' }],
          url: { name: 'MR Adds', url: 'https://raidplan.io/plan/LjZsRWUJahEe1fdM' }
        },
        {
          value: 'toxic',
          label: 'Hector/Toxic',
          url: { name: 'Toxic Adds', url: 'https://raidplan.io/plan/Pgj53K49w8LAZpI6' }
        },
        {
          value: 'latte',
          label: 'Latte',
          url: { name: 'Latte Adds', url: 'https://raidplan.io/plan/0066fd3CVp1_G36R' }
        },
        {
          value: 'yukizuri',
          label: 'Yukizuri',
          url: { name: 'Yukizuri Adds', url: 'https://www.youtube.com/watch?v=1LQ2OzMn7EE' }
        }
      ]
    }
  ],
