import type { FightConfig, Strat, TimelineItem, Badge } from '$lib/types';
    ...
    },
    {
      ...
      mechs: [
        ...
        },
        {
          mechanic: 'Debuffs',
          description:
            'Stack with your debuff timer partner\nShortest north, longest south\n10-15-20-25',
...
const hectorStrat: Strat = {
  ...
  notes:
    'This strat uses non-standard "Color Partners" that place OT on Yellow (East) and H2 on Blue (South)',
...
export const m5sFightConfig: FightConfig = {
  ...
  additionalResources: {
    ...
    description:
      'These strats are relatively unused in PF, either because they\'re new or outdated.<br>If you see a strat here that\'s picking up steam in PF, please <a target="_blank" rel="noopener noreferrer" class="anchor" href="https://docs.google.com/forms/d/e/1FAIpQLScJEJ43FKjSRJ2MyLuGXznce-P_SQNyPLWga_Xme_CJKPiQIQ/viewform?usp=header">let me know!</a>',
    links: [
      { text: 'Sun', url: 'https://raidplan.io/plan/h-WjosHQoM7oJR0n' },
      { text: 'Evansith Part 1', url: 'https://raidplan.io/plan/xLodsjMOZ3jGmopK' },
      { text: 'Evansith Part 2', url: 'https://raidplan.io/plan/iZdwA3hbQkp6HEsp' }
    ]
  }
};
