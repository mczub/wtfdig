import type { FightConfig, Strat, TimelineItem, StratRecord, PhaseStrats } from '$lib/types';
...
const quadMoonlight: StratRecord = {
  ...
  second: {
    ...
    MT: {
      ...
      party: 1,
      description:
        'Pre-position towards 3rd/4th Cleave safe quadrant\nSpread Left Close facing boss\nStack on intercard marker',
...
const toxicLament: StratRecord = {
  ...
  tethers: {
    MT: {
      ...
      party: 1,
      description:
        'Blue: Take solo tower SW, Let DPS move to SE first\nGreen: Take 2-person tower NW or NE with DPS',
    ...
    mechs: [
      {
        ...
        strats: [...getStratArray(decayStrats, 'start')]
      },
      {
        mechanic: 'Spreads',
        description: getStringObject(decayStrats, 'spreads', 'description'),
        strats: [...getStratArray(decayStrats, 'spreads')]
      },
      {
        mechanic: 'Towers',
        description: getStringObject(decayStrats, 'towers', 'description'),
        strats: [...getStratArray(decayStrats, 'towers')]
      }
    ]
  },
  {
      ...
      options: [
        {
          ...
          label: 'Fering',
          badges: [{ text: 'NA', class: 'na-badge' }],
          url: { name: 'Fering Decay', url: 'https://raidplan.io/plan/IRl6bjA5WzSweStq' }
        },
        {
          value: 'toxic',
          label: 'Toxic',
          badges: [{ text: 'EU', class: 'eu-badge' }],
          url: { name: 'Toxic Decay', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' }
        }
      ]
    },
    {
      ...
      options: [
        {
          ...
          label: 'Clock',
          badges: [{ text: 'NA', class: 'na-badge' }],
          url: { name: 'Clock Terrestrial', url: 'https://raidplan.io/plan/s3EIvZnk3qvuFy86' }
        },
        {
          value: 'toxic',
          label: 'Toxic',
          url: { name: 'Toxic Terrestrial', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' }
        },
        {
          value: 'dn',
          label: 'DN',
          url: { name: 'DN Terrestrial', url: 'https://www.youtube.com/watch?v=9tnQnMYHs1Q&t=975s' }
        },
      ...
      options: [
        {
          ...
          url: { name: 'Quad Moonlight', url: 'https://raidplan.io/plan/WFsLBku1C9Iyxneu' }
        },
        {
          value: 'toxic',
          label: 'Toxic',
          url: { name: 'Toxic Moonlight', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' }
        }
      ]
    },
    {
      ...
      options: [
        {
          ...
          url: { name: 'Toxic P2', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }
        }
      ]
    },
    {
      ...
      options: [
        {
          value: 'original',
          label: 'Original',
          url: { name: 'Original Twofold', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }
        },
        {
          value: 'casterse',
          label: 'Caster SE',
          badges: [{ text: 'EU', class: 'eu-badge' }],
          url: { name: 'Caster SE Twofold', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }
        }
      ]
    },
    {
      ...
      options: [
        {
          ...
          label: 'Rinon',
          badges: [{ text: 'NA', class: 'na-badge' }],
          url: { name: 'Rinon Lament', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }
        },
        {
          value: 'toxic',
          label: 'Toxic',
          badges: [{ text: 'EU', class: 'eu-badge' }],
          url: { name: 'Toxic Lament', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }
        }
      ]
    },
    {
      ...
      options: [
        {
          ...
          label: 'Rinon',
          badges: [{ text: 'NA', class: 'na-badge' }],
          url: { name: 'Rinon UV4', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }
        },
        {
          value: 'toxic',
          label: 'Toxic',
          badges: [{ text: 'EU', class: 'eu-badge' }],
          url: { name: 'Toxic UV4', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }
        }
      ]
    }
  ],
