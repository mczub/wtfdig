...
export const ex4FightConfig: FightConfig = {
  fightKey: 'ex4',
  ...
  toggles: [
    {
      ...
      defaultValue: null,
      options: [
        { value: 'supports', label: 'Supports bait first' },
        { value: 'dps', label: 'DPS bait first' },
        { value: 'dpsin', label: 'DPS in first' }
      ]
    },
    {
      key: 'bloom3',
    ...
    },
    {
      ...
      defaultValue: null,
      options: [
        { value: 'bd', label: 'Braindead (Clocks)' },
        { value: 'ns', label: 'N/S' },
        { value: 'we', label: 'W/E' }
      ]
    },
    ...
    },
    {
      ...
      options: [
        { value: 'lb3', label: 'LB3' },
        { value: 'ns', label: 'LP N/S' },
        { value: 'we', label: 'LP W/E' }
      ]
    }
  ]
};
...
export const ex4Strats: Strat[] = [raidplanStrat, hectorStrat, happyStrat, yukizuriStrat];
