...
const biliP2: Record<string, Record<string, string | PlayerMechStrat>> = {
  swing1spreads: {
    description:
      'Not specified in Bili P2 raidplan, Alpha P2 as reference\nMT M1 R1 Edge, OT M2 R2 Middle, Healers Middle',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'Small safe area (edge), deep in corner',
...
const alpha2P2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  strangeseedsbossnorth: {
    description:
      'Alternate seed drops between green and red spots\nBlue spots are safe\nBoth Healers take tethers',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const zenithP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  swing1spreads: {
    description:
      'Not specified in Zenith P2 raidplan, Alpha P2 as reference\nMT M1 R1 Edge, OT M2 R2 Middle, Healers Middle',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'Small safe area (edge), deep in corner',
  ...
  strangeseedsbossnorth: {
    description:
      'Alternate seed drops on Green and Red spots\nTethers have prio on highlighted spots',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const cuteP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  swing1spreads: {
    description:
      'Not specified in Cute P2 raidplan, Alpha P2 as reference\nMT M1 R1 Edge, OT M2 R2 Middle, Healers Middle',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'Small safe area (edge), deep in corner',
  ...
  strangeseedsbossnorth: {
    description:
      'Alternate seed drops on Red and Green dots\nUntethered party members stay near boss',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const lockedP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  swing1spreads: {
    description:
      'Not specified in Locked P2 raidplan, Alpha P2 as reference\nMT M1 R1 Edge, OT M2 R2 Middle, Healers Middle',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'Small safe area (edge), deep in corner',
  ...
  strangeseedsbossnorth: {
    description:
      'Alternate seed drops on Green and Red dots\nUntethered party members stay near boss',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const fixedP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  swing1spreads: {
    description:
      'Not specified in Fixed P2 raidplan, Alpha P2 as reference\nMT M1 R1 Edge, OT M2 R2 Middle, Healers Middle',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'Small safe area (edge), deep in corner',
...
const hectorP3: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  'debris-ranged-puddles': {
    description:
      'Ranged start on left side and bait puddles CCW\nMelees drop seeds on color markers',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const toxicP3: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  'debris-stacks': {
    description:
      'R1/MT North, R2/OT South, H1/M1 West, H2/M2 East\nPlace stacks 1 tile away from the wall',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'North',
...
const game8P3: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  'debris-ranged-puddles': {
    description:
      'Ranged start on South/West side and bait puddles towards North/East\nMelees drop seeds on cardinals',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
  ...
  'debris-melee-puddles': {
    description:
      'Melees start NW and bait AOEs CW around the boss\nRanged drop seeds on cardinals at the walls',
    MT: {
      role: 'Tank',
      party: 1,
      description: '',
...
const mrP3: Record<string, string | Record<string, string | PlayerMechStrat>> = {
  ...
  'debris-stacks': {
    description:
      'D3/MT North, D4/OT South, H1/D1 West, H2/D2 East\nPlace stacks 1 tile away from the wall',
    MT: {
      role: 'Tank',
      party: 1,
      description: 'North',
  ...
  strats: [
    {
      ...
      mechs: [
        ...
        },
        {
          mechanic: 'Seed and Puddle Drops',
          description:
            'Ranged drop puddles towards N/S then in\nMelee place seeds on intercard rivets',
          strats: [
            {
              role: 'Tank',
              party: 1,
