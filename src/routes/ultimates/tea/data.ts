      ...
      },
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Healer',
            party: 1,
            description: 'Move Southwest and bait puddles + South tornado protean towards West',
            imageUrl: './tea/living-liquid-14.webp'
          },
          {
            role: 'Healer',
          ...
          },
          {
            role: 'Ranged',
            party: 2,
            description: 'Move Southeast and bait puddles + East tornado protean towards South',
            imageUrl: './tea/living-liquid-14.webp'
          }
        ]
      },
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Stand max melee Southwest, get ready to bait West tornado protean',
            imageUrl: './tea/living-liquid-15.webp'
          },
          {
            role: 'Healer',
          ...
          },
          {
            role: 'Melee',
            party: 1,
            description: 'Stand max melee Southeast, get ready to bait South tornado protean',
            imageUrl: './tea/living-liquid-15.webp'
          },
          {
            role: 'Melee',
            party: 2,
            description: 'Stand max melee Northeast, get ready to bait East tornado protean',
            imageUrl: './tea/living-liquid-15.webp'
          },
          {
            role: 'Ranged',
      ...
      },
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Pull Hand Southwest, bait West tornado protean towards South',
            imageUrl: './tea/living-liquid-16.webp'
          },
          {
            role: 'Healer',
          ...
          },
          {
            role: 'Melee',
            party: 1,
            description: 'Stand Southeast, bait South tornado protean towards East',
            imageUrl: './tea/living-liquid-16.webp'
          },
          {
            role: 'Melee',
            party: 2,
            description: 'Stand Northeast, bait East tornado protean towards North',
            imageUrl: './tea/living-liquid-16.webp'
          },
          {
            role: 'Ranged',
        ...
        strats: [
          {
            role: 'Tank',
            party: 1,
            description: '\u26A0Provoke BJ and center boss before clock\nNorth',
            imageUrl: './tea/bjcc-1.webp'
          },
          {
            role: 'Tank',
            party: 2,
            description: '\u26A0Provoke CC and center boss before clock\nSouth',
            imageUrl: './tea/bjcc-1.webp'
          },
          {
            role: 'Healer',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Take CC South and point South to bait Spin Crusher',
            imageUrl: './tea/bjcc-9.webp'
          },
          {
            role: 'Healer',
            party: 1,
            description: 'If Water: stand on D marker\nIf no Water: stand N or E of Water',
            imageUrl: './tea/bjcc-9.webp'
          },
          {
            role: 'Healer',
      ...
      },
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Ranged',
            party: 2,
            description: 'Move South to prepare to bait mines with OT',
            imageUrl: './tea/bjcc-11.webp'
          }
        ]
      }
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Stay still after mine pop for pass with Phys Ranged',
            imageUrl: './tea/bjcc-18.webp'
          },
          {
            role: 'Healer',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Tank CC slightly West of C/3\nBe ready to point CC mid for shield',
            imageUrl: './tea/bjcc-19.webp'
          },
          {
            role: 'Healer',
      ...
      },
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: '\u26A0Point CC at Ranged for Plasma Shield',
            imageUrl: './tea/bjcc-20.webp'
          },
          {
            role: 'Healer',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Healer',
            party: 1,
            description: 'Chill in your lineup spot on the North or South side of center ring',
            imageUrl: './tea/bjcc-22.webp'
          },
          {
            role: 'Healer',
          ...
          },
          {
            role: 'Melee',
            party: 1,
            description: 'Keep hitting BJ and get ready for Third Pass',
            imageUrl: './tea/bjcc-22.webp'
          },
          {
            role: 'Melee',
          ...
          },
          {
            role: 'Ranged',
            party: 1,
            description: 'Hit shield from the front until it pops\nGet ready for Third Pass',
            imageUrl: './tea/bjcc-22.webp'
          },
          {
            role: 'Ranged',
        ...
        strats: [
          {
            role: 'Tank',
            party: 1,
            description: 'Stand in North lineup spot and wait for pass',
            imageUrl: './tea/bjcc-23.webp'
          },
          {
            role: 'Tank',
            party: 2,
            description: 'Stand in South lineup spot and wait for pass',
            imageUrl: './tea/bjcc-23.webp'
          },
          {
            role: 'Healer',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Melee',
            party: 2,
            description: 'Stand near mid and keep hitting BJ\nYou can join Water stack if you want',
            imageUrl: './tea/bjcc-25.webp'
          },
          {
            role: 'Ranged',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Tank',
            party: 2,
            description: '\u26A0Keep CC behind the ice until Propeller Wind cast',
            imageUrl: './tea/bjcc-28.webp'
          },
          {
            role: 'Healer',
    ...
    mechs: [
      {
        ...
        strats: [
          ...
          },
          {
            role: 'Ranged',
            party: 2,
            description: 'Get ready to move towards East wall to bait Super Jump',
            imageUrl: './tea/bjcc-30.webp'
          }
        ]
      },
        ...
        strats: [
          {
            role: 'Tank',
            party: 1,
            description: 'Stay on West side of arena until Apocalyptic Ray finishes',
      ...
      },
      {
        ...
        strats: [
          ...
          },
          {
            ...
            party: 1,
            description:
              'If {{shared-sentence}} West/Left with tanks\nElse: East/Right facing Heart',
            imageUrl: './tea/tea-p3-1-8.webp'
          },
          {
            role: 'Melee',
    ...
    mechs: [
      {
        ...
        description: 'Group center to bait Chakrams\nBJ/CC spawn NW and NE (can swap)',
...
const p4: PhaseStrats[] = [
  {
    ...
    mechs: [
      ...
      },
      {
        ...
        description: 'Lightly spread for Spread/Stack, then opposite',
  ...
  },
  {
    ...
    mechs: [
      ...
      },
      {
        ...
        description: 'Resolve first Motion/Stillness, then Debuffs + second Motion/Stillness',
  ...
  },
  {
    ...
    mechs: [
      ...
      },
      {
        ...
        description: 'If Stack, Light stack North, Dark stack Center\nMove to safe clone after',
