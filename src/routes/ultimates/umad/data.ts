      ...
      lb: [
        {
          mechanic: 'Debuffs',
          description:
            'Everyone: Headwind or Tailwind\n1 Sup + 1 DPS: Entropy (fire/spread), 1 Sup + 1 DPS: Dynamic Fluid (water/donut)\nOne element is Short (20s), the other Long (45s)\nHeadwind = face AWAY, Tailwind = face TOWARD the source',
