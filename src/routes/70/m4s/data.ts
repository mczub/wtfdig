...
const sunriseStrats: Record<string, StratRecord> = {
  autocad: autocadSunrise,
  normal: normalSunrise
};
      ...
      mechs: [
        {
          mechanic: 'Line AoEs',
          description:
            '5 beams from boss (north) and 5 from cubes (west)\nStand in safe intersections',
