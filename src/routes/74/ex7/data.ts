...
const arcanerevelationMechs: Record<string, MechanicStrat[]> = {
  normal: normalArcane,
  cheese: cheeseArcane,
  game8: game8Arcane
};
...
const staticRunaway: StratRecord = {
  ...
  spreads: {
    ...
    description:
      'Healers and Melee are static, ignore train direction\nRanged and Tanks will rotate'
  }
};
...
const runawayStrats: Record<string, StratRecord> = {
  alt: altRunaway,
  raidplan: raidplanRunaway,
  static: staticRunaway,
  game8: game8Runaway
};

const arcaneStrats: Record<string, MechanicStrat[]> = {
  normal: normalArcane,
  cheese: cheeseArcane,
  game8: game8Arcane
};
      ...
      mechs: [
        {
          ...
          description:
            'Targets both tanks with conal tankbusters\nTanks go towards train, MT left OT right',
