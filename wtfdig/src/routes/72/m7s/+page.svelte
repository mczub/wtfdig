...
<script lang="ts">
	...
	import { Modal, Segment, Switch } from '$lib/components/ui';
	...
	function getPFDescription() {
		...
		let stratDiffs = [stratNames[stratName]];
		if (
			stratState.p2 !== getStratMechs(stratName)['p2'] ||
			stratState.p3 !== getStratMechs(stratName)['p3'] ||
			stratName === 'kindred'
		) {
			if (stratState.p2 === 'toxic') {
	...
	{#snippet content()}
		...
		<div>
			<div class="card preset-outlined-warning-500 gap-4 p-4 mb-2">
				...
				<p>
					If you see a strat here that's picking up steam in PF, please <a
						target="_blank"
			...
			<div>
				...
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/9q3NYbwkt64Wswif'}>LA Uptime P1</a
					>
				</div>
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/fU48afCXIw8Sbb30'}>Shenpai P1</a
					>
				</div>
			</div>
			<div>
				...
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/gIcsj6_cyedVQON7'}>Toxic P2</a
					>
				</div>
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/jtQenPvoJy7hsV-x'}>Alpha 1.0 P2</a
					>
				</div>
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/zjpDmFrJ6VvUcDhV'}>Alpha 2.0 P2</a
					>
				</div>
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/2Y1HT42osFhYD6Pe'}>Zenith Seeds</a
					>
				</div>
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/xqt73wqsyzeykudf'}>QR Seeds</a
					>
				</div>
			</div>
			<div>
				...
				<div>
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href={'https://raidplan.io/plan/tFbTaL_Noj4ePdly'}>Cute Debris Deathmatch</a
					>
				</div>
			</div>
		</div>
...
<div class="container grow px-4 mx-auto mb-6">
	<div class="container">
		<div class="mb-6">
			<div class="preset-typo-display-1 mt-2 lg:mt-0 lg:-mb-2">AAC Cruiserweight M3 (Savage)</div>
				...
				{#if stratName}
					<div class="flex flex-row space-x-4 space-y-2 flex-wrap mb-2">
						<div class="flex flex-col">
							...
							>
								<Segment.Item value="locked" labelClasses="flex items-center"
									><span class="badge na-badge px-2 mr-2">NA</span>Locked</Segment.Item
								>
								<Segment.Item value="fixed" labelClasses="flex items-center"
									><span class="badge eu-badge px-2 mr-2">EU</span>Fixed</Segment.Item
								>
								<Segment.Item value="game8" labelClasses="flex items-center"
									><span class="badge jp-badge px-2 mr-2">JP</span>Game8/さり式</Segment.Item
								>
								<Segment.Item value="mr" labelClasses="flex items-center"
									><span class="badge oce-badge px-2 mr-2">OCE</span>MR</Segment.Item
								>
						...
						<div class="flex flex-col">
							...
							<div>
								<Segment
									classes="flex-wrap shrink"
									name="p3"
									value={stratState.p3}
									onValueChange={(e) => setStratState('p3', e.value)}
								>
									<Segment.Item value="toxic" labelClasses="flex items-center"
										><span class="badge na-badge px-2 mr-2">NA</span><span
											class="badge eu-badge px-2 mr-2">EU</span
							...
							{#if stratState.p3 && p3Urls[stratState.p3]}
								<div>
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										href={p3Urls[stratState.p3].url}
										>{p3Urls[stratState.p3].name}
										<ExternalLink />
									</a>
								</div>
							{/if}
