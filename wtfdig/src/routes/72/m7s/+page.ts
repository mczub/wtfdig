...
const cuteP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
    ...
    'swing1spreads': {
        'description': 'Not specified in Cute P2 raidplan, discuss with group',
        'MT': {
                role: 'Tank',
                party: 1,
                description: '',
...
const lockedP2: Record<string, string | Record<string, string | PlayerMechStrat>> = {
    ...
    'swing1spreads': {
        'description': 'Not specified in Locked P2 raidplan, discuss with group',
        'MT': {
                role: 'Tank',
                party: 1,
                description: '',
...
const p2Strats = {toxic: toxicP2, bili: biliP2, alpha: alphaP2, zenith: zenithP2, alpha2: alpha2P2, cute: cuteP2, locked: lockedP2}
