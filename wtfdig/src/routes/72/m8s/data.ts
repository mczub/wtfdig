...
const decayStrats: Record<string, StratRecord> = {
    'toxic': toxicDecay,
    'fer': feringDecay,
}

const terrestrialStrats: Record<string, StratRecord> = {
    'clock': clockTerrestrial,
    'dn': dnTerrestrial,
    'toxic': toxicTerrestrial,
    'fullr': fullRinonTerrestrial,
    'halfr': halfRinonTerrestrial,
}

const moonlightStrats: Record<string, StratRecord> = {
    'quad': quadMoonlight,
    'toxic': toxicMoonlight,
}

const p2Strats: Record<string, StratRecord> = {
    'toxic': toxicP2,
}

const twofoldStrats: Record<string, StratRecord> = {
    'original': originalTwofold,
    'casterse': casterseTwofold,
}

const lamentStrats: Record<string, StratRecord> = {
    'toxic': toxicLament,
    'rinon': rinonLament,
}

const uv4Strats: Record<string, StratRecord> = {
    'toxic': toxicUV4,
    'rinon': rinonUV4,
}
...
export const m8sStrats = [pbr, r84ddog, toxicStrat, pbeQ3];

export const m8sFightConfig: FightConfig = {
    fightKey: 'm8s',
    ...
    strats: {
        ...
        'pb-eQ': {
            label: 'Pastebin',
            defaultPfDescription: 'Toxic | Fering | Clock | Quad | Toxic P2',
            defaults: {
                decay: 'toxic',
                terrestrial: 'toxic',
                moonlight: 'toxic',
        ...
        'pb-r': {
            label: 'Pastebin + Rinon',
            defaultPfDescription: 'Toxic | Fering | Clock | Quad | Rinon Lament/UV4',
        ...
        '84ddog': {
            label: '84ddog',
            defaultPfDescription: '84d+DOG | Full Rinon',
    ...
    toggles: [
        {
            key: 'decay',
            label: 'Millennial Decay',
            defaultValue: null,
            options: [
                { value: 'fer', label: 'Fering', badges: [{ text: 'NA', class: 'na-badge' }], url: { name: 'Fering Decay', url: 'https://raidplan.io/plan/IRl6bjA5WzSweStq' } },
                { value: 'toxic', label: 'Toxic', badges: [{ text: 'EU', class: 'eu-badge' }], url: { name: 'Toxic Decay', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' } },
            ]
        },
        {
            key: 'terrestrial',
            label: 'Terrestrial Rage',
            defaultValue: null,
            options: [
                { value: 'clock', label: 'Clock', badges: [{ text: 'NA', class: 'na-badge' }], url: { name: 'Clock Terrestrial', url: 'https://raidplan.io/plan/s3EIvZnk3qvuFy86' }, },
                { value: 'toxic', label: 'Toxic', url: { name: 'Toxic Terrestrial', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' }, },
                { value: 'dn', label: 'DN', url: { name: 'DN Terrestrial', url: 'https://www.youtube.com/watch?v=9tnQnMYHs1Q&t=975s' }, },
                { value: 'fullr', label: 'Full Rinon', badges: [{ text: 'EU', class: 'eu-badge' }] },
                { value: 'halfr', label: 'Half Rinon' },
            ]
        },
        {
            key: 'moonlight',
            ...
            defaultValue: null,
            options: [
                { value: 'quad', label: 'Quad', badges: [{ text: 'NA', class: 'na-badge' }, { text: 'EU', class: 'eu-badge' }], url: { name: 'Quad Moonlight', url: 'https://raidplan.io/plan/WFsLBku1C9Iyxneu' }, },
                { value: 'toxic', label: 'Toxic', url: { name: 'Toxic Moonlight', url: 'https://raidplan.io/plan/46uVU6o49FPuYXOs' }, },
            ]
        },
        {
            key: 'p2',
            ...
            defaultValue: null,
            options: [
                { value: 'toxic', label: 'Toxic', badges: [{ text: 'NA', class: 'na-badge' }, { text: 'EU', class: 'eu-badge' }], url: { name: 'Toxic P2', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }, },
            ]
        },
        {
            key: 'twofold',
            ...
            defaultValue: null,
            options: [
                { value: 'original', label: 'Original', url: { name: 'Original Twofold', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }, },
                { value: 'casterse', label: 'Caster SE', badges: [{ text: 'EU', class: 'eu-badge' }], url: { name: 'Caster SE Twofold', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }, },
            ]
        },
        {
            key: 'lament',
            ...
            defaultValue: null,
            options: [
                { value: 'rinon', label: 'Rinon', badges: [{ text: 'NA', class: 'na-badge' }], url: { name: 'Rinon Lament', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }, },
                { value: 'toxic', label: 'Toxic', badges: [{ text: 'EU', class: 'eu-badge' }], url: { name: 'Toxic Lament', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }, },
            ]
        },
        {
            key: 'uv4',
            ...
            defaultValue: null,
            options: [
                { value: 'rinon', label: 'Rinon', badges: [{ text: 'NA', class: 'na-badge' }], url: { name: 'Rinon UV4', url: 'https://raidplan.io/plan/Zzf38hNz9aFrn-6T' }, },
                { value: 'toxic', label: 'Toxic', badges: [{ text: 'EU', class: 'eu-badge' }], url: { name: 'Toxic UV4', url: 'https://raidplan.io/plan/9M-1G-mmOaaroDOG' }, },
            ]
        },
    ],
