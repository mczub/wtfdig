    ...
    toggles: [
        {
            ...
            defaultValue: null,
            options: [
                { value: 'cleave', label: 'Cleavemaxxing', badges: [{ text: 'NA', class: 'na-badge' }, { text: 'EU', class: 'eu-badge' }], url: { name: 'Cleavemaxxing Adds', url: 'https://raidplan.io/plan/ywV9cu6GRQ68SQLy' } },
                { value: 'game8', label: 'Game8', badges: [{ text: 'JP', class: 'jp-badge' }], url: { name: 'Game8 Adds', url: 'https://game8.jp/ff14/681086' } },
                { value: 'mr', label: 'MR', badges: [{ text: 'OCE', class: 'oce-badge' }], url: { name: 'MR Adds', url: 'https://raidplan.io/plan/LjZsRWUJahEe1fdM' } },
                { value: 'toxic', label: 'Hector/Toxic', url: { name: 'Toxic Adds', url: 'https://raidplan.io/plan/Pgj53K49w8LAZpI6' }, },
                { value: 'latte', label: 'Latte', url: { name: 'Latte Adds', url: 'https://raidplan.io/plan/0066fd3CVp1_G36R' }, },
                { value: 'yukizuri', label: 'Yukizuri', url: { name: 'Yukizuri Adds', url: 'https://www.youtube.com/watch?v=1LQ2OzMn7EE' }, },
            ]
        }
    ],
    timeline: timeline
