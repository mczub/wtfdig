	...
	{#snippet content()}
		...
		<article>
			<div>
				...
				<p>
					5/2/2025: rearranged strats, added badges to indicate region standards, add game8 m6s +
					m7s, add oce m5s
				</p>
				<p>5/1/2025: updated fering decay diagrams, fix twofold line baits</p>
				<p>
					4/27/2025: highlights for m5s hector, split m7s p3 hector strat out into its own thing
				</p>
				...
				<p>
					4/12/2025: m8s + renamed m6s toxic to hector/toxic, update ex4 hector bloom6 to match
					video, added ko-fi link
				</p>
				...
				<p>
					1/3/2025: added wfJ/o1Z to the raidplan selector, changed Add Relative to Wall Relative
					for CODCAR
				</p>
				<p>
...
<!--header class="w-full mx-auto px-6 py-6 border-b border-gray-600 flex-none z-50 relative">
	<div class="grid grid-cols-1 md:grid-cols-3 justify-items-stretch items-center">
		...
		<div class="flex flex-wrap gap-2 md:justify-end my-4 md:ml-4 md:my-0">
			...
			<button
				type="button"
				onclick={() => changelogOpen()}
				class="btn preset-tonal border border-surface-500 px-6">Changelog</button
			>
		</div>
	</div>
</header-->
...
<footer
	class="bottom-0 left-0 z-40 w-full p-4 border-t shadow-sm md:flex md:items-center md:justify-between md:p-6 bg-surface-1000 border-gray-600"
>
	<div class="flex flex-col lg:flex-row w-full max-w-(--breakpoint-xl) mx-auto justify-between">
